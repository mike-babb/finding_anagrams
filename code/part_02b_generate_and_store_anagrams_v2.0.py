...
def run_it(matrix_extraction_option: int, n_subset_letters: int, write_data: bool,
...
if __name__ == '__main__':
    ...
    run_it(matrix_extraction_option=matrix_extraction_option, n_subset_letters=n_subset_letters,
